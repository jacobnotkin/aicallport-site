import { getSupabaseAdmin, handleError, json, nextRevision, readJsonBody, requireAccountContext } from "./_shared.js";
...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === "GET") {
      ...
      return json(res, 200, { companyId: context.companyId, userId: context.user.id, role: context.role, assignments: data || [] });
    }
    if (req.method === "POST") {
